...
# Create downloads folder once when bot starts
...
# Video + Audio Quality options
    ...
    try:
        filename = await loop.run_in_executor(None, yt_dlp_download_blocking, url, ydl_opts)
        return filename
...
# Ignore replies to any messages
...
# No matching URL, ignore message
    if not video_url:
        return
